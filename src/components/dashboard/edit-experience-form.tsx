...
export default function EditExperienceForm({ experience, businessId, productCount }: EditExperienceFormProps) {
      ...
      <CardHeader>
        ...
        {productCount > 0 && (
          <p className="text-sm text-yellow-600">
            This experience has {productCount} product{productCount !== 1 ? 's' : ''} and cannot be deleted.
          </p>
        )}
      </CardHeader>
      <CardContent>
